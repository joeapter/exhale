...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const retreat = await prisma.retreat.findUnique({ where: { slug }, select: { title: true, overview: true, startDate: true } });
            ...
            >
              ...
              <div className="space-y-4 mb-8">
                {retreat.packages.map((pkg) => (
                  <div
                    key={pkg.id}
                    style={{ borderBottom: "1px solid rgba(184,144,128,0.2)", paddingBottom: "1rem" }}
                  >
              ...
              {isSoldOut ? (
                <div className="text-center py-4">
                  <p className="label-sm text-[#9B8F84] mb-4" style={{ letterSpacing: "0.12em" }}>
